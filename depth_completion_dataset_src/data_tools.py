...
class TransformUtils(object):
    ...
    def _sample_lidar_line(self, depth_map):
        """
        Giữ lại giá trị depth theo một dòng giữa ảnh, cách 5 pixel một lần.
        Các pixel còn lại sẽ được gán giá trị 0.
        """
        ...
        for col in range(0, width, 5):
            sampled[..., mid_row, col] = depth_map[..., mid_row, col]
    ...
    def trans_raw(self, gt, hole_gt, hole_ls):
        ...
        raw = self._sample_lidar_line(raw)
        return raw
