            ...
            try:
                ...
                for scan in scan_generator:
                    ...
                    for p in current_scan_data:
                        ...
                        for pt in img_pts:
                            ...
                            if 0 <= center[0] < width and 0 <= center[1] < height:
                                ...
                                visible_lidar_metadata.append({
                                    "angle_degrees": float(angle),
                                    "distance_mm": float(distance),
                                    "quality": int(quality)
                                })
                                cv2.circle(fusion_frame, center, 2, color, -1)
                    ...
                    if key == ord('s'):
                        ...
                        lidar_json = {
                            "meta": {
                                "total_visible_points": len(visible_pixel_points)
                            },
                            ...
                            "labels": {
                                ...
                                "lidar_metadata": visible_lidar_metadata
                            }
                        }
