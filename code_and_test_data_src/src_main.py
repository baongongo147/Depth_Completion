...
class G2_MonoDepth:
    def __init__(self, cf, rank):
        ...
        # rgbd_dir = Path(
        #     r"D:\UsingSpace\Projects\Artificial Intelligent\ComputerVision\Depth-Inference-with-RGBD-Camera\RGBD_Datasets\UnrealCV")
        # hole_dir = Path(
        #     r"D:\UsingSpace\Projects\Artificial Intelligent\ComputerVision\Depth-Inference-with-RGBD-Camera\Hole_Datasets\HRWSI")  # folder containing hole masks
        rgbd_dir = self.configs.rgbd_dirs
        hole_dir = self.configs.hole_dirs
    ...
    def optimize_one_iteration(self, rgb, gt, raw):
        ...
        with autocast(enabled=(self.scaler is not None)):
            ...
            loss = 1.5 * loss_adepth + loss_rdepth + 0.5 * loss_rgrad
